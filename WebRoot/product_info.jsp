...
<html>
	...
	<head>
		...
		<meta charset="utf-8" />
		<meta name="description" content="LiuZhe Group、ForFuturn News,LiuZhe Share,LiuZhe Shopping" />
		...
		<div class="showall">
			...
			<div class="extInfo">
				...
				<div class="brand-logo">
					<a href="http://ganquanzhong.top" title="LiuZhe商城自营">
						<img src="img/logo.png" width="220" height="90"/>
					</a>
				</div>
				
				<div class="seller-pop-box">
						<span class="tr">LiuZhe Shop商城自营</span>
					<span class="tr">Just for a better liuzhe shop</span>
					<span class="tr"><a href="localhost:8080/shop" target="_blank">LiuZhe Shop</a></span>
						<span class="tr hoh">
		            	<a title="LiuZhe1号商城" href="localhost:8080/shop" target="_blank">总部：LiuZhe1号商城</a>
			          </span>
				</div>
			...
			$(function(){
				...
				$.ajax({
					...
					success : function(data) {
						var strs=new Array();
						strs=data.image.split(",");	//修正图片的正确路径
					...
					addOrders:function(){
						if(confirm("亲,您确定直接购买么!")){
							if(this.pInfo.total<=0 || this.pInfo.total==null){
								...
								alert('该商品的库存不足,请重新选择购买数量!');//判断购买的数量是否小于库存数量
							}else{
								//获取信息，将其加入购物车中
								var subtotal=this.quantity*(this.pInfo.newPrice);	//计算商品的总价
								var params={
										"pid":getQueryString("pid"),
