...
<meta name="author" content="LiuZhe Shop"/>
        ...
        <div class="col-md-8"
            ...
            <form class="form-horizontal" style="margin-top: 5px;" id="Form" v-on:submit.prevent="modify()">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="email" class="form-control" id="email" name="email" :value="userList.email"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="addr" name="addr" :value="userList.addr"
                               v-model="userList.addr">
                    </div>
                </div>
                <div class="form-group">
                    <label for="addr" class="col-sm-2 control-label">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="code" name="code" :value="userList.code"
